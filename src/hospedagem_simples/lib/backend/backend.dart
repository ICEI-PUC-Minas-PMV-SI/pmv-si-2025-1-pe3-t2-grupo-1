...
import 'schema/room_type_record.dart';
...
export 'schema/room_type_record.dart';
...
/// Functions to query RoomTypeRecords (as a Stream and as a Future).
Future<int> queryRoomTypeRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RoomTypeRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RoomTypeRecord>> queryRoomTypeRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RoomTypeRecord.collection,
      RoomTypeRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RoomTypeRecord>> queryRoomTypeRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
