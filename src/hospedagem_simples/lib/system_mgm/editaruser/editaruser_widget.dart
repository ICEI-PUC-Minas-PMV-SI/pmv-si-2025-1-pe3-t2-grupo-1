...
class EditaruserWidget extends StatefulWidget {
  ...
  final UsersRecord? userin;

  static String routeName = 'Editaruser';
  static String routePath = '/editaruser';
...
class _EditaruserWidgetState extends State<EditaruserWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: widget!.userin?.displayName);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController();
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??= TextEditingController(text: widget!.userin?.cpf);
